...
| MinIO       | http://localhost:9001    | minio / (file)  |

Grafana auto-provisions three dashboards: **deepCab — API** (latency p50/p95/p99, error rate), **deepCab — Agent** (tool calls, tokens, USD), **deepCab — Training** (runs, epoch duration).
