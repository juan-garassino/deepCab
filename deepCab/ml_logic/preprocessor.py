...
from deepCab.ml_logic.encoders import (
    ...
    def create_sklearn_preprocessor() -> ColumnTransformer:
        ...
        time_pipe = make_pipeline(
            ...
            make_column_transformer(
                ...
                (
                    FunctionTransformer(
                        lambda year: (year - year_min) / (year_max - year_min)
                    ),
                    [4],
                ),  # min-max scale the columns 4 ["year"]
        ...
        geohash_pipe = make_pipeline(
            ...
            OneHotEncoder(
                categories=geohash_categories, handle_unknown="ignore", sparse=False
            ),
        )
